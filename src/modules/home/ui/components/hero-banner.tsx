...
export const HeroBanner: React.FC = () => {
  return (
    <section className="relative min-h-[calc(100vh-5rem)] lg:min-h-screen w-full flex flex-col justify-center pt-24 sm:pt-28 lg:pt-20 pb-12 sm:pb-16 lg:pb-10 overflow-hidden bg-slate-50 text-slate-900 border-b border-slate-200/80">
      ...
      {/* Ambient Lighting */}
      <div className="absolute top-1/4 left-1/3 w-[350px] sm:w-[550px] h-[350px] sm:h-[550px] rounded-full blur-[100px] sm:blur-[130px] -z-10 pointer-events-none bg-emerald-500/10" />
      <div className="absolute top-1/3 right-1/4 w-[300px] sm:w-[480px] h-[300px] sm:h-[480px] rounded-full blur-[90px] sm:blur-[120px] -z-10 pointer-events-none bg-teal-500/10" />
      ...
      <div className="max-w-[1720px] relative z-20 mx-auto px-4 sm:px-6 lg:px-12 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          
          {/* Left Column: Headline, Direct Copy, CTAs & Metrics */}
          <div className="col-span-12 lg:col-span-6 space-y-6 flex flex-col justify-center max-w-2xl lg:max-w-none">
            ...
            >
              <Link
                href="/products"
                className="group relative inline-flex items-center justify-center px-7 py-3.5 bg-emerald-600 rounded-xl text-white font-bold text-sm sm:text-base hover:bg-emerald-700 transition-all duration-200 shadow-lg shadow-emerald-600/20 hover:-translate-y-0.5 active:translate-y-0 text-center"
              >
              ...
              <Link
                href="/quick-order"
                className="inline-flex items-center justify-center px-7 py-3.5 bg-white hover:bg-slate-50 text-slate-800 font-bold text-sm sm:text-base border border-slate-300/90 shadow-xs rounded-xl hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 text-center"
              >
                Request a Quote
              </Link>
            </motion.div>
          ...
          {/* Right Column: Interactive Scientific Dashboard (Desktop Only - Hidden on Mobile) */}
          <motion.div
            initial={{ opacity: 0, scale: 0.98, x: 20 }}
            animate={{ opacity: 1, scale: 1, x: 0 }}
            transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1], delay: 0.15 }}
            className="hidden lg:flex lg:col-span-6 w-full justify-center"
          >
